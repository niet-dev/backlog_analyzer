...
Open `.env.sample`. Here you will see `CLIENT_ID` and `CLIENT_SECRET`. Replace the sample values with your own Client ID and Secret, then rename the file from `.env.sample` to `.env`.
